<header class="main-header">
	...
	<span class="logo-mini"><img src="<?php if ($dir != $root_folder) echo "../"; ?>gambar/konfig/<?php echo loadKonfigurasi("logo_web"); ?>" height="50px"></span>
	<!-- logo for regular state and mobile devices -->
	<span class="logo-lg"><img src="<?php if ($dir != $root_folder) echo "../"; ?>gambar/konfig/<?php echo loadKonfigurasi("logo_web"); ?>" height="50px"> <?php echo loadKonfigurasi("nama_web"); ?></span>
	</a>
