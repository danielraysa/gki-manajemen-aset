<?php
    ...
    if(isset($_POST['datatable'])) {
        $_sql = "SELECT * FROM daftar_baru db LEFT JOIN merk m on db.ID_MERK = m.ID_MERK LEFT JOIN lokasi l on db.LOKASI_BARANG = l.ID_LOKASI LEFT JOIN ruangan r on db.RUANGAN_BARANG = r.ID_RUANGAN ";
        ...
        $full_query = $query.$order." LIMIT ".$limit." OFFSET ".$start;
