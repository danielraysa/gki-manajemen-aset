        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Tambah Data Status Baru</h3>
                </div>
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="nama" placeholder="Nama status untuk barang">
                        </div>  
                    </div>
              ...
              <table id="example1" class="table table-bordered table-hover table-responsive" width="100%">
                ...
                <tbody>
                    <?php
                        ...
                        $a = 1;
                        $query = mysqli_query($koneksi, "SELECT * FROM status WHERE STATUS = 'Aktif'");
