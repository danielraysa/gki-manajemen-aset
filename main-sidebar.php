    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="histori-peminjaman/"><i class="fa fa-area-chart text-red"></i> Histori Peminjaman</a></li>
            <li><a href="histori-mutasi/"><i class="fa fa-clipboard text-green"></i> Histori Mutasi Lokasi</a></li>
            <li><a href="maintenance-sarpras/"><i class="fa fa-gears text-blue"></i> Perawatan Sarana Prasarana</a></li>
          </ul>
        </li>
        <li>
