        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Tambah Data Ruangan Baru</h3>
                </div>
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="kode" placeholder="Kode ruangan untuk kode inventaris">
                        </div>  
                    </div>
              ...
              <table id="example1" class="table table-bordered table-hover table-responsive" width="100%">
                ...
                <tbody>
                    <?php
                        ...
                        $a = 1;
                        $query = mysqli_query($koneksi, "SELECT * FROM ruangan WHERE STATUS_RUANGAN = 'Aktif'");
        ...
        <form action="form-action.php" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Hapus Data Ruangan</h4>
                </div>
